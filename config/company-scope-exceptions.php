...
return [
    ...
    \Webkul\Partner\Models\Address::class => [
        ...
        'alias_of'       => \Webkul\Partner\Models\Partner::class,
    ...
    \Webkul\Support\Models\Company::class => [
        'table'          => 'companies',
    ...
    \Webkul\Security\Models\Company::class => [
        'table'          => 'companies',
        'classification' => 'alias',
        'alias_of'       => \Webkul\Support\Models\Company::class,
    ...
    \Webkul\Security\Models\User::class => [
        'table'          => 'users',
    ...
    \Webkul\Security\Models\Permission::class => [
        'table'          => 'permissions',
    ...
    \Webkul\PluginManager\Models\Plugin::class => [
        'table'          => 'plugins',
        'classification' => 'not_tenancy',
    ...
    \Webkul\Support\Models\EmailLog::class => [
        'table'          => 'email_logs',
        'classification' => 'not_tenancy',
    ...
    \Webkul\Website\Models\Page::class => [
        'table'          => 'website_pages',
        'classification' => 'not_tenancy',
    ...
    \Webkul\Support\Models\Currency::class => [
        'table'          => 'currencies',
    ...
    \Webkul\Accounting\Models\Currency::class => [
        'table'          => 'currencies',
        'classification' => 'alias',
        'alias_of'       => \Webkul\Support\Models\Currency::class,
    ...
    \Webkul\Partner\Models\Bank::class => [
        'table'          => 'banks',
        'classification' => 'alias',
        'alias_of'       => \Webkul\Support\Models\Bank::class,
    ...
    \Webkul\Support\Models\UOM::class => [
    ...
    \Webkul\Support\Models\UTMMedium::class => [
        'table'          => 'utm_mediums',
        'classification' => 'global_reference',
    ...
    \Webkul\Recruitment\Models\UTMMedium::class => [
        'table'          => 'utm_mediums',
        'classification' => 'alias',
        'alias_of'       => \Webkul\Support\Models\UTMMedium::class,
        'reason'         => 'Plugin-scoped alias of Webkul\\Support\\Models\\UTMMedium.',
        'tracking'       => '#138',
    ],
    \Webkul\Support\Models\UTMSource::class => [
        'table'          => 'utm_sources',
        'classification' => 'global_reference',
    ...
    \Webkul\Recruitment\Models\UTMSource::class => [
        'table'          => 'utm_sources',
        'classification' => 'alias',
        'alias_of'       => \Webkul\Support\Models\UTMSource::class,
        'reason'         => 'Plugin-scoped alias of Webkul\\Support\\Models\\UTMSource.',
        'tracking'       => '#138',
    ],
    \Webkul\Support\Models\UtmStage::class => [
        'table'          => 'utm_stages',
        'classification' => 'global_reference',
    ...
    \Webkul\Product\Models\Attribute::class => [
    ...
    \Webkul\Accounting\Models\Attribute::class => [
        'table'          => 'products_attributes',
        'classification' => 'alias',
        'alias_of'       => \Webkul\Product\Models\Attribute::class,
    ...
    \Webkul\Product\Models\AttributeOption::class => [
    ...
    \Webkul\Account\Models\Account::class => [
    ...
    \Webkul\Accounting\Models\Account::class => [
        'table'          => 'accounts_accounts',
        'classification' => 'alias',
        'alias_of'       => \Webkul\Account\Models\Account::class,
        'reason'         => 'Plugin-scoped alias of Webkul\\Account\\Models\\Account.',
        'tracking'       => '#138',
    ],
    \Webkul\Account\Models\AccountAccountTag::class => [
    ...
    \Webkul\Account\Models\AccountJournal::class => [
    ...
    \Webkul\Account\Models\AccountPaymentRegisterMoveLine::class => [
    ...
    \Webkul\Account\Models\AccountTax::class => [
    ...
    \Webkul\Account\Models\FullReconcile::class => [
    ...
    \Webkul\Account\Models\PaymentMethodLine::class => [
    ...
    \Webkul\Account\Models\PaymentMethod::class => [
    ...
    \Webkul\Account\Models\ProductSupplierTaxes::class => [
    ...
    \Webkul\Account\Models\ProductTaxes::class => [
    ...
    \Webkul\Account\Models\TaxTaxes::class => [
    ...
    \Webkul\Account\Models\Incoterm::class => [
    ...
    \Webkul\Accounting\Models\Incoterm::class => [
        'table'          => 'accounts_incoterms',
        'classification' => 'alias',
        'alias_of'       => \Webkul\Account\Models\Incoterm::class,
    ...
    \Webkul\Account\Models\CashRounding::class => [
    ...
    \Webkul\Accounting\Models\CashRounding::class => [
        'table'          => 'accounts_cash_roundings',
        'classification' => 'alias',
        'alias_of'       => \Webkul\Account\Models\CashRounding::class,
        'reason'         => 'Plugin-scoped alias of Webkul\\Account\\Models\\CashRounding.',
        'tracking'       => '#138',
    ],
    \Webkul\Sale\Models\OrderLine::class => [
    ...
    \Webkul\Product\Models\ProductAttribute::class => [
    ...
    \Webkul\Product\Models\ProductCombination::class => [
    ...
    \Webkul\Inventory\Models\ProcurementGroup::class => [
    ...
    \Webkul\Manufacturing\Models\ProcurementGroup::class => [
        'table'          => 'inventories_procurement_groups',
        'classification' => 'alias',
        'alias_of'       => \Webkul\Inventory\Models\ProcurementGroup::class,
        'reason'         => 'Plugin-scoped alias of Webkul\\Inventory\\Models\\ProcurementGroup.',
        'tracking'       => '#138',
    ],
    \Webkul\Inventory\Models\PackageDestination::class => [
    ...
    \Webkul\Inventory\Models\ProductQuantityRelocation::class => [
    ...
    \Webkul\Inventory\Models\StorageCategoryCapacity::class => [
    ...
    \Webkul\Purchase\Models\OrderGroup::class => [
    ...
    \Webkul\Manufacturing\Models\WorkOrder::class => [
    ...
    \Webkul\Manufacturing\Models\WorkCenterCapacity::class => [
    ...
    \Webkul\Manufacturing\Models\Operation::class => [
    ...
    \Webkul\Manufacturing\Models\WorkCenterLossType::class => [
    ...
    \Webkul\Manufacturing\Models\WorkCenterTag::class => [
    ...
    \Webkul\Manufacturing\Models\WorkCenterProductivityLoss::class => [
    ...
    \Webkul\Employee\Models\EmployeeCategory::class => [
    ...
    \Webkul\Employee\Models\DepartureReason::class => [
        'table'          => 'employees_departure_reasons',
        'classification' => 'global_reference',
        'reason'         => 'Standalone HR taxonomy, no FK to a tenant-owned entity.',
        'tracking'       => '#138',
    ],
    \Webkul\Employee\Models\EmployeeResumeLineType::class => [
    ...
    \Webkul\Employee\Models\EmploymentType::class => [
    ...
    \Webkul\Recruitment\Models\EmploymentType::class => [
        'table'          => 'employees_employment_types',
        'classification' => 'alias',
        'alias_of'       => \Webkul\Employee\Models\EmploymentType::class,
        'reason'         => 'Plugin-scoped alias of Webkul\\Employee\\Models\\EmploymentType.',
        'tracking'       => '#138',
    ],
    \Webkul\Employee\Models\SkillType::class => [
    ...
    \Webkul\Recruitment\Models\SkillType::class => [
        'table'          => 'employees_skill_types',
        'classification' => 'alias',
        'alias_of'       => \Webkul\Employee\Models\SkillType::class,
        'reason'         => 'Plugin-scoped alias of Webkul\\Employee\\Models\\SkillType.',
        'tracking'       => '#138',
    ],
    \Webkul\Employee\Models\SkillLevel::class => [
    ...
    \Webkul\Partner\Models\Industry::class => [
    ...
    \Webkul\Contact\Models\Industry::class => [
        'table'          => 'partners_industries',
        'classification' => 'alias',
        'alias_of'       => \Webkul\Partner\Models\Industry::class,
    ...
    \Webkul\Partner\Models\Title::class => [
    ...
    \Webkul\Contact\Models\Title::class => [
        'table'          => 'partners_titles',
        'classification' => 'alias',
        'alias_of'       => \Webkul\Partner\Models\Title::class,
